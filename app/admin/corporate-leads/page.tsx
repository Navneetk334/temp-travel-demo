          ...
          {activeLead ? (
            <div className="bg-slate-900 border border-white/5 p-6 rounded-2xl space-y-6 glassmorphism">
              ...
              <div className="space-y-3 border-t border-white/5 pt-4 text-xs text-slate-300">
                ...
                <div className="flex justify-between items-center bg-slate-950/40 p-2.5 rounded-lg border border-white/5">
                  <span className="text-slate-400">Employee Headcount:</span>
                  <span className="font-bold text-slate-100">{activeLead.employeeCount || "Not Specified"}</span>
                </div>

                {activeLead.pickupLocations && (
                  <div className="bg-slate-950/40 p-3 rounded-lg border border-white/5 space-y-1">
                    <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Pickup Locations</div>
                    <div className="text-slate-200 whitespace-pre-line leading-relaxed">{activeLead.pickupLocations}</div>
                  </div>
                )}
