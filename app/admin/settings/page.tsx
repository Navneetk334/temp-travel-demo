  ...
  return (
    <div className="bg-background min-h-screen text-slate-100 p-8 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        {/* Settings Form */}
        <form onSubmit={handleSave} className="lg:col-span-8 bg-surface border border-border p-6 md:p-8 rounded-xl space-y-6 glassmorphism">
          <h2 className="text-lg font-bold text-slate-50 border-b border-border pb-3">Corporate Branding Details</h2>
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full bg-background/60 border border-border rounded-lg py-2.5 px-4 text-sm text-slate-100 focus:outline-none focus:border-primary transition-all"
            />
          </div>

          <h2 className="text-lg font-bold text-slate-50 border-b border-border pb-3 pt-4">Support & Contact Coordinates</h2>
          ...
          <h2 className="text-lg font-bold text-slate-50 border-b border-border pb-3 pt-4">Global Search Metadata (SEO)</h2>
        ...
        {/* Security / Help card */}
        <div className="lg:col-span-4 bg-surface border border-border p-6 rounded-xl space-y-4 glassmorphism text-xs text-slate-300">
          ...
          <div className="text-[10px] text-slate-500 pt-2 border-t border-border leading-relaxed">
