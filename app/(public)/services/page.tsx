  ...
  const services = [
    {
      ...
      image: "/images/services/corporate-transportation.png",
      icon: Building2,
    ...
    },
    {
      ...
      image: "/images/services/employee-commutes.png",
      icon: Clock,
    ...
    },
    {
      ...
      image: "/images/services/local-rentals.png",
      icon: Clock,
    ...
    },
    {
      ...
      image: "/images/services/outstation-cabs.png",
      icon: MapPin,
    ...
    },
    {
      ...
      image: "/images/services/domestic-tours.png",
      icon: Compass,
    ...
    },
    {
      ...
      image: "/images/services/international-tours.png",
      icon: Globe,
    ...
    },
    {
      ...
      image: "/images/services/customized-travel.png",
      icon: Settings,
  ...
  return (
    <>
      ...
      <div className="bg-background text-slate-100 min-h-screen">
        ...
        <section className="relative bg-background overflow-hidden border-b border-border pb-16">
          ...
          <div className="max-w-[1750px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 text-center space-y-6 relative z-10 pt-4">
            <span className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-[0.3em] text-amber-400 bg-amber-500/10 border border-amber-500/20 px-4 py-1.5 rounded-full">
              ...
              <span>Our Fleet & Tour Offerings</span>
            </span>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight text-slate-50">
              Corporate & Leisure <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-amber-200 to-amber-500">Transit Offerings</span>
            </h1>
        ...
        {/* Services Bento Grid */}
        <section className="py-20 px-4 sm:px-8 lg:px-12 xl:px-16 max-w-[1750px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
          {services.map((item) => {
