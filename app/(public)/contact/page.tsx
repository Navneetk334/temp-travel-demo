...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      <div className="bg-background text-slate-50 min-h-screen">
        ...
        <section className="relative bg-background overflow-hidden border-b border-border pb-20">
          ...
          <div className="max-w-[1750px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 text-center space-y-6 relative z-10 pt-4">
            <span className="text-xs font-bold text-accent uppercase tracking-widest bg-background/5 border border-border px-3 py-1 rounded-full">
              Get In Touch
            </span>
            ...
            <p className="text-slate-400 max-w-3xl mx-auto text-base sm:text-lg leading-relaxed font-medium">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="glassmorphism p-6 rounded-xl border border-border space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-bold text-slate-50 text-base">Phone Hotlines</h3>
                </div>
              ...
              <div className="glassmorphism p-6 rounded-xl border border-border space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-bold text-slate-50 text-base">Email Inquiries</h3>
                </div>
                <div className="space-y-1.5 pl-11 text-sm text-slate-400">
                  <div className="flex justify-between items-center">
              ...
              <div className="glassmorphism p-6 rounded-xl border border-border space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-bold text-slate-50 text-base">Corporate Head Office</h3>
                </div>
                <div className="pl-11 text-sm text-slate-400 leading-relaxed font-semibold">
                  TEMP TRAVEL CAR RENTALS PVT. LTD.
                  <div className="font-normal text-slate-400 mt-1">
              ...
              <div className="bg-amber-950/20 border border-accent/20 p-6 rounded-xl space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-bold text-slate-50 text-base">24/7 Emergency Support</h3>
                </div>
        ...
        <section className="py-16 bg-slate-900/20 border-t border-border">
          <div className="max-w-[1750px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 space-y-8">
            ...
            <div className="relative bg-slate-950 border border-border rounded-2xl h-[420px] overflow-hidden shadow-2xl group">
              {/* Real Google Maps Embed Iframe */}
              <iframe
                title="TEMP TRAVEL CAR RENTALS PVT LTD - Google Maps Location"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3503.779060922279!2d77.0282024759316!3d28.576396486626955!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d1bdd91329ae5%3A0xb6eacebf9445cb73!2sTEMP%20TRAVEL%20CAR%20RENTALS%20PVT%20LTD!5e0!3m2!1sen!2sin!4v1789652484585!5m2!1sen!2sin"
              ...
              <div className="absolute bottom-4 left-4 right-4 md:left-auto md:right-4 bg-background/90 backdrop-blur-md border border-white/15 p-4 rounded-xl flex items-center justify-between gap-4 shadow-2xl z-10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-extrabold text-slate-50 text-xs sm:text-sm">TEMP TRAVEL CAR RENTALS PVT. LTD.</h3>
