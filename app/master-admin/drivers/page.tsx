  ...
  return (
    <div className="space-y-6">
            ...
            return (
              ...
              >
                <div className="space-y-3">
                  ...
                  <div className="space-y-1.5 bg-background p-3 rounded-xl border border-border text-xs font-mono">
            ...
            <div className="bg-surface border border-amber-500/30 rounded-3xl p-6 sm:p-8 w-[95vw] md:w-[85vw] max-w-6xl shadow-2xl space-y-6 relative text-slate-100 max-h-[95vh] overflow-y-auto">
              ...
              >
                ...
                <div className="space-y-3 pt-3 border-t border-border">
                  <h4 className="text-amber-400 font-extrabold uppercase text-[11px] tracking-wider flex items-center gap-1.5 border-b border-border pb-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full bg-background border border-border rounded-xl px-3 py-2 text-slate-300 text-xs file:mr-2 file:py-1 file:px-2 file:rounded-lg file:border-0 file:text-xs file:font-bold file:bg-amber-500 file:text-slate-950 cursor-pointer"
                      />
                    </div>
                    <div className="space-y-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className={`w-full bg-background border rounded-xl px-3 py-2 text-slate-100 focus:outline-none font-mono ${formData.confirmAccountNumber && formData.accountNumber !== formData.confirmAccountNumber
      ...
      {selectedDriver && (
        <Portal>
          <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-black/85 backdrop-blur-md">
            <div className="bg-surface border border-amber-500/30 rounded-3xl p-6 sm:p-8 w-full max-w-md shadow-2xl space-y-4 relative text-slate-100">
              <button
              ...
              <div className="space-y-2 text-xs font-mono bg-background p-4 rounded-2xl border border-border">
                <div className="flex justify-between">
              ...
              <div className="pt-2 flex justify-end">
                <button
                  onClick={() => setSelectedDriver(null)}
                  className="px-5 py-2 bg-background border border-border hover:border-white/20 text-slate-200 rounded-xl text-xs font-bold"
                >
                  Close File
                </button>
              </div>
